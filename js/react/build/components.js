var CatalogView = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			'div',
			null,
			React.createElement(CategoryFilterList, { categoryFilters: _this.state.categoryFilter, setCategoryFilter: _this.setCategoryFilter }),
			React.createElement(
				'div',
				{ className: 'col1of2' },
			...
			React.createElement(
				'div',
				{ className: 'col1of2' },
				React.createElement(Entry, { item: _this.props.items[activeEntry], addCategoryFilter: _this.addCategoryFilter })
			)
		);
	}
});
...
var EntryListItem = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			'li',
			{ key: _this.props.itemKey, className: _this.props.isActive ? 'active' : '', onClick: _this.handleClick.bind(_this, _this.props.itemKey) },
			React.createElement(
				'p',
				null,
				_this.props.company
	...
	render: function () {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(Payment, { payment: item.payment }),
				React.createElement('hr', null),
				React.createElement(
					'div',
					...
					React.createElement(
						'h3',
						null,
						'Contact' + (item.contact.length > 1 ? 's' : '')
					),
					contactList.length ? contactList : React.createElement(
						'em',
						null,
...
var CategoryFilterList = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			'ul',
			{ className: 'category-filter-list', style: { display: displayCategories ? 'block' : 'none' } },
			categoryList
		);
	}
});
...
var CategoryLink = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			'a',
			{ className: 'category-link', href: '#', onClick: _this.handleClick.bind(_this, [_this.props.category]) },
			_this.props.category.ucFirst()
		);
	}
});
...
var LinkWithRemove = React.createClass({
	render: function () {
		...
		return React.createElement(
			'li',
			{ className: 'delete-link', onClick: _this.props.removeAction.bind(null, _this.props.val) },
			React.createElement('i', { className: 'fa fa-remove' }),
			React.createElement(
				'a',
				{ className: 'delete-link', href: '#' },
				_this.props.label.ucFirst()
			)
		);
	}
});
...
var Payment = React.createClass({
	render: function () {
		...
		return _this.props.payment ? React.createElement(
			'div',
			...
			React.createElement(
				...
				amount || frequency || type ? null : React.createElement(
					'em',
					null,
	...
	render: function () {
		...
		return React.createElement(
			...
			React.createElement(
				'div',
				null,
				contact.address ? React.createElement(
					'p',
					null,
					contact.address
				) : null,
				contact.city ? React.createElement(
					'p',
					null,
